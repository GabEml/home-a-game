...
<section class="row">
    <div class="col-12">
       ...
       <article class="mb-3">
        ...
        <img class="banniere_petite align-self-center img-fluid" src="{{$article->image_path}}"  alt="trophee">
       </div>
       <br/>
         ...
         <div class="containerForArticle">
            <h2 class="titleArticle">{{$article->title}}</h2>
            <br/>
            <p class="nameDate">Par <span class="name">{{$article->user->firstname}}</span> écrit le {{$article->created_at}}</p>
         </div>
         <br/>
         <div class="containerForArticle">
