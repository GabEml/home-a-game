...
class SessiongameUserController extends Controller
{
    ...
    public function storePayment(Request $request)
    {
        $fr_errors = [
            ...
            "payment_intent_authentication_failure" => "La source fournie a échoué l'authentification. Fournissez source_data ou une nouvelle source pour tenter de répondre à nouveau à ce PaymentIntent.",
        ...
        if($test->isEmpty()){
            ...
            for ($i = 0; $i < sizeof($validateData["sessiongames"]); $i++) {
                ...
                $test = array_search ($e->getError()->code, $fr_errors);
                

                return back()->with('errorStripe', $fr_errors[$e->getError()->code]);
